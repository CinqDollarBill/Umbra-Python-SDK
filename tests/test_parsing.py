...
def test_position_market_value_and_outcome():
    ...
    flat = Position.from_api(
        {"market_id": "m2", "net_qty": 0, "avg_entry_price": "0", "realized_pnl": "0"}
    )
...
def test_fee_summary_net_earner():
    s = FeeSummary.from_api(
        {
            "user_id": "u",
            "currency": "USDC",
            "total_fees_paid": "1",
            "total_rebates_received": "3",
            "net_fees": "-2",
            "maker_trades": 1,
            "taker_trades": 1,
            "average_fee_per_trade": "1",
            "average_rebate_per_trade": "1.5",
        }
    )
